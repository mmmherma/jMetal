...
import org.uma.jmetal.problem.singleobjective.TSPNewYork;
 ...
 */
public class GenerationalGeneticAlgorithmTSPNewYorkRunner {
  /**
  ...
  public static void main(String[] args) throws Exception {
    ...
    problem = new TSPNewYork("resources/tspInstances/NYDOT.json");
